...
FREQUENCIES VARIABLES=ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 
  ...
  /STATISTICS=MINIMUM MAXIMUM SEMEAN MEDIAN MODE SKEWNESS SESKEW
  /HISTOGRAM NORMAL
  /ORDER=ANALYSIS.
...
CORRELATIONS
  /VARIABLES=sex party liberal ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER  ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar14 ar15 ar16 
    ar17 ar18 ar19 ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar29.

**combine variables 5 &13

COMPUTE ar29=((mean(ar5)  +  mean(ar13))/2).
EXECUTE.

FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar14 ar15 ar16 ar17 ar18 ar19 ar20 ar21 
    ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar14 ar15 ar16 ar17 ar18 ar19 ar20 ar21 
    ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar29
...
set mxloops=20000 printback=off width=80  seed = 1953125.
matrix.
...
GET raw / FILE = * / missing=omit / VAR = ar1 to ar29.

* Enter the desired number of parallel data sets here.
compute ndatsets = 10000.
...
save results /outfile= 'C:\Users\miawe\Documents\Lund University\WPM\SIMM32\Lab 6\SPSS\parallel analysis\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\miawe\Documents\Lund University\WPM\SIMM32\Lab 6\SPSS\parallel analysis\screedata.sav'.
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar14 ar15 ar16 ar17 ar18 ar19 ar20 
    ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /SAVE MAHAL.

SORT CASES BY MAH_2(A).

COMPUTE pvalue=($CASENUM-0.5)/150.
EXECUTE.

COMPUTE chisq=IDF.CHISQ(pvalue,27).
EXECUTE.

* Chart Builder.
GGRAPH
  /GRAPHDATASET NAME="graphdataset" VARIABLES=MAH_2 chisq MISSING=LISTWISE REPORTMISSING=NO
...
BEGIN GPL
  ...
  ELEMENT: point(position(MAH_2*chisq))
END GPL.
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar16 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27 ar28 ar29 ar14
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar16 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27 ar28 ar29 ar14
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27 ar28 ar29
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27 ar28 ar29
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /SAVE MAHAL.
...
COMPUTE chisq2=IDF.CHISQ(pvalue,25).
EXECUTE.
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER FAC1_2 FAC2_2 FAC3_2 FAC4_2 ar1 ar2 ar3 ar4 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar15 
    ar17 ar18 ar19 ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar29
  /SAVE MAHAL.
